...
class ContactUs extends StateNotifier<ApiState<TermsOfServiceModel>> {
  ContactUs(this.repo) : super(const ApiState.initial()) {
    getContactUS();
  }
  ...
  Future<void> getContactUS() async {
    ...
    try {
      final TermsOfServiceModel data = await repo.getContactUS();
