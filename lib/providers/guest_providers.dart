...
final productsProviderData = StateNotifierProvider.autoDispose<ProductsNotifierData,
    ApiState<ProductsModel>>((ref) {
  return ProductsNotifierData(
    ref.watch(guestRepoProvider),
    ref.watch(productsFilterProviderData),
  );
});
...
final productsFilterProviderData =
StateProvider<ProducServiceVariavtionDataModel>((ref) {
  return ProducServiceVariavtionDataModel(servieID: '', variationID: '');
});