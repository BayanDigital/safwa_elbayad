    ...
    return TableRow(
      children: [
        Padding(
          ...
          child: Text(
            title,
            style: AppTextDecor.osRegular12black.copyWith(color: AppColors.textColor,fontWeight: FontWeight.w700),
        ...
        Padding(
          ...
          child: Text(
            data,
            style: AppTextDecor.osRegular12black.copyWith(color: AppColors.secondaryColor,fontWeight: FontWeight.w800),
            textAlign: Hive.box(AppHSC.appSettingsBox)
                        .get(AppHSC.appLocal)
                        .toString() ==
                    "ar"
    ...
    return TableRow(
      children: [
        ...
        Padding(
          ...
          child: Text(
            data,
            style: AppTextDecor.osBold14black.copyWith(color: AppColors.primary,fontSize: 12,fontWeight: FontWeight.w800),
            textAlign: Hive.box(AppHSC.appSettingsBox)
                        .get(AppHSC.appLocal)
                        .toString() ==
                    "ar"
