...
class ProductData {
  ...
  factory ProductData.fromMap(Map<String, dynamic> data) => ProductData(
        id: data['id'] as int?,
  ...
  factory ProductData.fromJson(String data) {
    return ProductData.fromMap(json.decode(data) as Map<String, dynamic>);
  }
