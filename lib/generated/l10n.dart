...
import 'package:laundry_customer/generated/intl/messages_all.dart';
...
class S {
  ...
  String get wats {
    return Intl.message(
      ...
      name: 'wats',
      desc: 'Button or link to contact via WhatsApp',
      args: [],
    );
  }
  ...
  String get newBorn {
    return Intl.message(
      'A bouquet of flowers for a newborn',
      name: 'A bouquet of flowers for a newborn',
      desc: '',
      args: [],
    );
  }
  String get Valentine
  {
    return Intl.message(
      'Valentine Day bouquets',
      name: 'Valentine Day bouquets',
      desc: '',
      args: [],
    );
  }
  String get redFlower
  {
    return Intl.message(
      'Dazzling red rose bouquet',
      name: 'Dazzling red rose bouquet',
      desc: '',
      args: [],
    );
  }
  String get specialFlower
  {
    return Intl.message(
      'Featured flower section',
      name: 'Featured flower section',
      desc: '',
      args: [],
    );
  }
  ...
  String get bet {
    return Intl.message(
      'Home Number',
      name: 'bet',
      desc: 'Label for entering home number',
      args: [],
    );
  }
  String get deleteAccountTitle {
    return Intl.message(
      ...
      desc: 'Title for delete account screen or dialog',
    );
  }
  String get deleteAccountPrompt {
    return Intl.message(
      ...
      desc: 'Short confirmation message before deleting the account',
    );
  }
  ...
  String get deleteAccountWarning {
    return Intl.message(
      'Are you sure you want to delete your account? All your data and order history will be lost, and this action cannot be undone.',
      name: 'deleteAccountWarning',
      desc: 'Warning message shown before account deletion',
      args: [],
    );
  }
  /// `Confirm Order`
