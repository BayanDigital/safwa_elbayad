...
import 'package:laundry_customer/screens/homePage/best_seller_screen.dart';
...
import 'package:laundry_customer/screens/homePage/edit_profile_screen.dart';
...
import 'package:laundry_customer/screens/onBoarding/splash.dart';
...
class Routes {
  ...
  */
  ...
  static const bestSellersDetails = '/bestSellersDetails';
  // static const messageScreen = '/messageScreen';
...
Route generatedRoutes(RouteSettings settings) {
  ...
  switch (settings.name) {
    ...
    case Routes.onBoarding:
      child = WaterOnBoardingScreen();
    case Routes.splashSecond:
      child = const Splash();
    ...
    case Routes.recoverPassWordStageTwo:
      ...
      child = RecoverPasswordStageTwo(forEmailorPhone: email);
    case Routes.recoverPassWordStageThree:
      final rawArgs = settings.arguments! as Map<String, dynamic>;
      final args = rawArgs.map((key, value) => MapEntry(key, value?.toString() ?? ''));
